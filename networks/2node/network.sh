...
# and applications. The test network consists of two organizations with two
...
# material.
# In here Fabric CAs are used to generate the crypto material. CAs sign the certificates
...
function networkDown() {
  # stop containers for org1, org2 and org3
...
# Using Fabric CA for setting up CA
